export type NavHref = '/' | '/blog' | '/search' | '/about' | '/pictures' | '/projects' | '/plans' | '/tools' | '/works' | '/thoughts' | '/bookmarks'
...
const DEFAULT_NAV_ITEMS: NavItemConfig[] = [
  ...
  { id: 'plans', label: '计划', href: '/plans', icon: 'CalendarCheck', visible: true, sortOrder: 6 },
  { id: 'tools', label: '工具', href: '/tools', icon: 'Wrench', visible: true, sortOrder: 7 },
  { id: 'works', label: '作品', href: '/works', icon: 'LayoutGrid', visible: true, sortOrder: 8 },
  { id: 'thoughts', label: '随笔', href: '/thoughts', icon: 'MessageCircle', visible: true, sortOrder: 9 },
  { id: 'bookmarks', label: '收藏', href: '/bookmarks', icon: 'Bookmark', visible: true, sortOrder: 10 },
]
